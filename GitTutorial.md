...
* Чтобы отправить изменеyия из локального в удfлённый ,существует команда *git push*  ,попробуем это сделать,сохраняем изменения - пишем коммит- и отправляем изменения командой git push 
